...
const Assets = () => {
    ...
    const getApi = async () => {
        ...
        setLocation1(data.results[0].location.street.number + " " + data.results[0].location.street.name)
    ...
    return (
        <div className='mainDiv'>
            <span><img className="logo" src={clarus} alt="" /></span>
            {(card.length > 0) && (
            ...
            <div className='card-container'>
                    ...
                    <nav className='icons'>
                        ...
                        <img onMouseOver={()=>{
                            setInfo2(name)
                            setInfo("name")}} src={genderPhoto} alt="" />
                        {/* <img src={woman} alt="" /> */}
                        <img onMouseOver={()=>{
                            setInfo2(mail1)
                            setInfo("mail")}} src={mail} alt="" />
                        <img onMouseOver={()=>{
                            setInfo2(age1)
                            setInfo("age")}} src={agePhoto} alt="" />
                        {/* <img src={ageWoman} alt="" /> */}
                        <img onMouseOver={()=>{
                            setInfo2(location1)
                            setInfo("adress")}} src={location} alt="" />
                        <img onMouseOver={()=>{
                            setInfo2(phone1)
                            setInfo("phone")}} src={phone} alt="" />
                        <img onMouseOver={()=>{
                            setInfo2(padlock1)
                            setInfo("password")}} src={padlock} alt="" />
                    </nav>
                    <nav>
                        <button onClick={handleClick}>New User</button>
                        <button>Add User</button>
                    </nav>
                    <div><AddUser card={card}/></div>
